		...
		<div class="container">
			<div class="row" style="text-align: center">
				<div id="mapdiv">
					...
					<input type="button" value="이미지 업로드" class="btn btn-lg btn-success onebtn"
					onclick="location.href='/member/attach?email=${email}'">
					<input type="button" value="추가정보 입력/수정" class="btn btn-lg btn-success onebtn"
					onclick="location.href='/member/additional?email=${email}'">
					<input type="button" value="기본정보 수정" class="btn btn-lg btn-success onebtn"
...
//					circle.setMap(null); // 원래 이걸로 기존 서클 지우는데 제이쿼리 안에선 안먹힘..
				...
				makeCircle(latitud, longitude, rng.val(), map);
			});
	...
	function makeCircle (latitud, longitude, val, map) {
		// 지도에 표시할 원을 생성합니다
		var circle = new kakao.maps.Circle({
			center : new kakao.maps.LatLng(latitud, longitude), // 원의 중심좌표 입니다 
			radius : val*1000, // 미터 단위의 원의 반지름입니다
